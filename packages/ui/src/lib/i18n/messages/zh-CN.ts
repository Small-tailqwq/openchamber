...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.scheduledTasks.editor.time.period.am': '上午',
  'sessions.scheduledTasks.editor.time.period.pm': '下午',
  ...
  'chat.emptyState.draftTitle': '今天想做点什么？',
  'chat.emptyState.draftTitleWithProject': '在 {project} 中想做点什么？',
  'chat.draftPresets.explore.label': '探索代码库',
  'chat.draftPresets.catchup.label': '了解最新进展',
  'chat.draftPresets.weigh.label': '权衡方案',
  'chat.draftPresets.plan.label': '开始功能规划',
  'chat.draftPresets.debug.label': '调试问题',
  'chat.draftPresets.review.label': '审查代码变更',
  'chat.draftStarters.add': '添加快捷指令',
